...
//
//// Global variables for managing native instances
//static std::unique_ptr<RtpServer> g_rtp_server;
//
...
//
//    auto nalRanges = extractNalUnitRanges(data, position, limit);
//    return static_cast<jint>(nalRanges.size());
//}
//
//// ============================================================================
//// Audio Frame Callback Function
//// ============================================================================
//
//
//// ============================================================================
//// Native RTP Server JNI Interface
//// ============================================================================
//
//extern "C" JNIEXPORT void JNICALL
//Java_com_pntt3011_cameraserver_server_NativeRtpServer_initializeServer(JNIEnv *env, jclass clazz)
//{
//    if (!g_rtp_server)
//    {
//        g_rtp_server = std::make_unique<RtpServer>();
//    }
//}
//
//extern "C" JNIEXPORT void JNICALL
//Java_com_pntt3011_cameraserver_server_NativeRtpServer_destroyServer(JNIEnv *env, jclass clazz)
//{
//    if (g_rtp_server)
//    {
//        g_rtp_server.reset();
...
//Java_com_pntt3011_cameraserver_server_NativeRtpServer_createTcpSession(JNIEnv *env, jclass clazz,
//                                                                       jobject output_stream,
//                                                                       jint video_interleave,
//                                                                       jint audio_interleave)
//{
//    if (!g_rtp_server)
//    {
//        return -1;
//    }
//
//    return g_rtp_server->create_tcp_session(env, output_stream, video_interleave, audio_interleave);
//}
//
//extern "C" JNIEXPORT void JNICALL
//Java_com_pntt3011_cameraserver_server_NativeRtpServer_removeSession(JNIEnv *env, jclass clazz,
//                                                                    jlong session_id)
//{
//    if (g_rtp_server)
//    {
//        g_rtp_server->remove_session(session_id);
//    }
//}
//
//extern "C" JNIEXPORT void JNICALL
//Java_com_pntt3011_cameraserver_server_NativeRtpServer_sendVideoFrame(JNIEnv *env, jclass clazz,
//                                                                     jobject buffer,
//                                                                     jint position,
//                                                                     jint limit,
//                                                                     jlong timestamp_us)
...
//    g_rtp_server->send_video_frame(data + position, size, timestamp_us);
//}
//
//extern "C" JNIEXPORT void JNICALL
//Java_com_pntt3011_cameraserver_server_NativeRtpServer_sendAudioFrame(JNIEnv *env, jclass clazz,
//                                                                     jobject buffer,
//                                                                     jint position,
//                                                                     jint limit,
//                                                                     jlong timestamp_us)
...
//
//    size_t size = limit - position;
//    g_rtp_server->send_audio_frame(data + position, size, timestamp_us);
//}
//
//extern "C" JNIEXPORT void JNICALL
//Java_com_pntt3011_cameraserver_server_NativeRtpServer_stopAllSessions(JNIEnv *env, jclass clazz)
//{
//    if (g_rtp_server)
//    {
//        g_rtp_server->stop_all_sessions();
//    }
//}
//
//// ============================================================================
//// Native Audio Frame Queue JNI Interface
//// ============================================================================
